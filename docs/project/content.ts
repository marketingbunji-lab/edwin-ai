  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        "Knowledge Base ya se organiza como un flujo lineal de 4 pasos: Brand Setup, Program Content Base, University Content Base y Golden Circle.",
    ...
    },
    {
      ...
      items: [
        ...
        "University Content Base quedó definido como una experiencia singleton por marca bajo `/admin/brands/[brand]/university` con subrutas `new` y `edit`.",
