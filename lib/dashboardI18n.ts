...
export const dashboardMessages = {
  en: {
    ...
    brandCard: {
      ...
      landingSingular: "landing",
      landingPlural: "landings",
    },
    landings: {
  ...
  es: {
    ...
    home: {
      ...
      descriptionHighlight:
        "Gestiona marca, contenido y activacion de landings",
      descriptionTail:
        "para cada universidad o institucion en un solo lugar.",
      workspaceChip: "Workspace de EDwin",
    },
    brandCard: {
      edit: "Editar",
