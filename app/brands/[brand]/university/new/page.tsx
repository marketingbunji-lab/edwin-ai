...
import UniversityProfileNewWorkspace from "@/components/university/UniversityProfileNewWorkspace";
  ...
  return (
    <main className="admin-page">
      <div className="admin-page-inner">
            ...
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <h1 className="truncate text-lg font-semibold text-slate-950 dark:text-slate-50 sm:text-xl">
                  Configurar University Content Base
                </h1>
              </div>
            </div>
          </div>
        ...
        <UniversityProfileNewWorkspace brand={brand} />
      </div>
    </main>
  );
}
